...
export function Footer() {
  return (
    <footer className="border-t border-white/10 bg-black py-12 md:py-16 text-slate-400">
      <div className="mx-auto max-w-[1400px] px-6 md:px-10">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="pt-2">
              <a
                href="mailto:contacto@realsimexperience.com"
              ...
              >
                ...
                contacto@realsimexperience.com
              </a>
            </div>
          </div>
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500 font-semibold">
          <div>
