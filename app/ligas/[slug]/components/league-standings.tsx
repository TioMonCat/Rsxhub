                          ...
                          {canEditPoints ? (
                            <div className="flex items-center gap-1 shrink-0">
                              <input
                                ...
                                className="w-16 bg-slate-900 text-cyan-300 font-mono font-black text-xs px-2 py-1 border border-slate-700 focus:border-cyan-400 text-center rounded-none"
                                title="Edit Points (Admins & Stewards only)"
                              />
                              <span className="text-[10px] font-bold text-slate-400 font-mono">pts</span>
                            </div>
                          ) : (
