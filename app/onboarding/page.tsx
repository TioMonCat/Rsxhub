    ...
    <div className="min-h-[80vh] flex items-center justify-center py-10 px-4">
      <div className="w-full max-w-2xl bg-gradient-to-b from-[#111622] to-[#0a0d14] border border-white/10 p-6 md:p-8 relative shadow-2xl">
        ...
        <div className="text-center mb-8">
          <p className="text-xs uppercase tracking-[0.25em] text-[#1274de] font-bold">Welcome to the Platform</p>
          <h1 className="mt-2 text-3xl font-extrabold text-white tracking-tight uppercase">Complete Your Driver Profile</h1>
          <p className="mt-2 text-sm text-slate-400 max-w-md mx-auto">
            Set your initial preferences to customize your sim racing experience.
          </p>
        </div>
