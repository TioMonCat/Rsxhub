          ...
          <div className="flex items-start md:items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5 font-mono">
                Steam ID: {session.steamId} ┬À {getCountryName(profile.countryCode)} ┬À {simulatorLabel(profile.mainSim)}
              </p>
                ...
                return (
                  <div key={registration.id} className="border border-shell-line bg-black/20 p-3 rounded-none">
                    ...
                    <p className="text-xs text-slate-400">
                      ...
                      {registration.classTag ? ` ┬À ${registration.classTag}` : ''}
                      {registration.assignedNumber ? ` ┬À #${registration.assignedNumber}` : ''}
                    </p>
                  </div>
                )
              })
