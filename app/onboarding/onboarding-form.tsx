    ...
    <form action={saveOnboarding} onSubmit={handleSubmit} className="space-y-6 text-white">
      ...
      <div className="flex items-center gap-4 bg-white/5 border border-white/10 p-4 rounded-none">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[10px] uppercase tracking-wider text-[#1274de] font-bold">Synced Steam Account</p>
          <p className="text-sm font-semibold truncate text-white">{defaultData.displayName}</p>
          <p className="text-[11px] text-slate-400 mt-0.5">
            We display your Steam profile picture directly without downloading to preserve privacy.
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        />
        <p className="text-[10px] text-slate-500 mt-1">This name will be displayed across leaderboards and registrations.</p>
      </div>
      ...
      <div>
        ...
        <p className="text-[10px] text-slate-500 mt-1">
          Your country determines the flag displayed next to your driver name.
        </p>
      </div>
      ...
      <div>
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          >
            ...
            <span className="mt-1 text-[11px] text-slate-400">AC Racing Platform</span>
          </button>
      ...
      <div className="border border-white/10 bg-black/20 p-4 rounded-none">
        ...
        <p className="text-[11px] text-slate-400 mt-0.5">Select the vehicle classes you prefer competing in.</p>
      ...
      >
        {pending ? 'Processing registration...' : 'Save Profile & Enter Cockpit'}
      </button>
    </form>
  )
}
